...
**vadd_<数据类型简写>**  64位数据相加。

架构支持：v7, A32, A64

<br>

**vaddq_<数据类型简写>**  128位数据相加。

架构支持：v7, A32, A64

<br>

**vaddl_<数据类型简写>**  长指令相加，结果数据是操作数位数的两倍。

架构支持：v7, A32, A64

<br>

**指令形式：** vaddl_high_<数据类型简写>

**说明：** 操作数a的后半部分（高位）元素加上操作数b的后半部分（高位）元素，结果数据位数扩大两倍存储。
