...
**说明：** 64位数据相加；支持架构：v7, A32, A64。

<br>

**2. vaddq_<数据类型简写>**

**说明：** 128位数据相加；支持架构：v7, A32, A64。

<br>

**3. vaddl_<数据类型简写>**

**说明：** 长指令，结果数据是操作数位数的两倍；支持架构：v7, A32, A64。

<br>

**4. vaddl_high_<数据类型简写>**

**说明：** 长指令；a和b的后半元素（高位数据）相加，结果位数扩大两倍存储；支持架构：A64。
...
> 宽指令；a和b通道数相同，a的位数是b的两倍，结果位数与操作数a相同。支持架构：v7, A32, A64。
...
> 饱和指令；有符号操作数a和无符合操作数b对应通道元素相加，超出范围的自动限制在有符号数表示范围内。
